    ...
    en: {
      ...
      farmer: {
        Overheating: [
          ...
          "Warm leaves lose comfort quickly. Change only the location, then let the temperature sensor tell us whether it helped.",
          "A bright place can also become a hot place, my young friend. Shade first, then observe before changing anything else.",
          "Grandpa's rule for heat: one small move, a quiet wait, and one fresh temperature reading.",
          "The sensor is warning us before the leaves have to. That is useful wisdom—cool the surroundings gently and check again.",
        ],
        TooCold: [
          ...
          "Cold drafts can reach a pot before we notice them. Find a steadier place away from AC, then ask the sensor again.",
          "Warmth should come gently, my young friend—not from a sudden heater. A safer room spot is the first step.",
          "One careful move is enough for now. Let the temperature settle before deciding on a second change.",
          "The number says the little one is chilly. Keep it away from cold windows or vents and watch the next reading.",
        ],
        DryAir: [
          ...
          "Air humidity is the blanket around the leaves, not water inside the soil. Move away from drying airflow and measure again.",
          "A fan may feel gentle to us but keep pulling moisture from the air around a leaf. Try a quieter spot first.",
          "Do not let one dry-air number make us guess about the soil. We change the air, wait, and listen to the humidity sensor.",
          "Good gardeners name the problem correctly: dry air. That means we fix the surroundings, not invent a soil problem.",
        ],
        HumidAir: [
          ...
          "Still, heavy air can linger around leaves. Give the plant gentle ventilation, then see whether humidity comes down.",
          "Fresh air is useful; a harsh fan is not. Choose a mild airflow and change only that one thing.",
          "When air humidity stays high, leaves need breathing room. Check that they are not crowded against a wall.",
          "Let us open the space around the plant, wait a moment, and ask the humidity sensor for a new clue.",
        ],
        Sleepy: [
          ...
          "If it is daytime, the light sensor is asking us to find a brighter safe place. At night, darkness is simply bedtime.",
          "Move toward daylight carefully, but do not trade darkness for dangerous heat. Check both light and temperature afterward.",
          "A curtain is the smallest change, so start there. Then let the light sensor show whether it was enough.",
          "Plants follow the day, my young friend. Give this one safe morning light and observe before moving it again.",
        ],
        Soil: [
          ...
          "A pH number is a clue to record, not a recipe. Show it to a teacher or local farmer before any treatment.",
          "Changing soil chemistry without guidance can create a second problem. Write down the reading and ask an experienced adult.",
          "Let us measure once more before judging the soil. If the number stays off, bring both readings to your teacher.",
          "Wise farming includes knowing when to ask for help. Soil pH is one of those times, my young friend.",
        ],
        Happy: [
          ...
          "When every reading is comfortable, doing less can be wiser than doing more. Keep the surroundings steady.",
          "Healthy numbers are not an invitation to fuss, my young friend. Observe, remember, and let the plant grow.",
          "The garden is teaching us balance today: enough light, gentle air, and patient hands.",
        ],
        idle: {
          companion: [
    ...
    id: {
      ...
      farmer: {
        Overheating: [
          ...
          "Daun cepat kehilangan kenyamanan saat kepanasan. Ubah tempatnya saja, lalu biarkan sensor suhu menunjukkan hasilnya.",
          "Tempat yang terang juga bisa menjadi terlalu panas, Nak. Cari teduh dulu, lalu amati sebelum mengubah hal lain.",
          "Aturan Kakek saat panas: satu perpindahan kecil, tunggu dengan tenang, lalu baca suhu yang baru.",
          "Sensor memperingatkan kita sebelum daun harus berteriak. Sejukkan sekitarnya dengan lembut, lalu periksa lagi.",
        ],
        TooCold: [
          ...
          "Angin dingin bisa mencapai pot sebelum kita menyadarinya. Jauhkan dari AC, lalu tanyakan lagi kepada sensor.",
          "Menghangatkan harus pelan-pelan, Nak, bukan dengan pemanas mendadak. Tempat ruangan yang aman adalah langkah pertama.",
          "Satu perpindahan hati-hati cukup untuk sekarang. Tunggu suhu stabil sebelum membuat perubahan kedua.",
          "Angkanya bilang si kecil kedinginan. Jauhkan dari jendela atau ventilasi dingin dan lihat bacaan berikutnya.",
        ],
        DryAir: [
          ...
          "Kelembapan udara adalah selimut di sekitar daun, bukan air di dalam tanah. Jauhkan dari aliran udara kering, lalu ukur lagi.",
          "Kipas terasa lembut bagi kita, tetapi bisa terus mengeringkan udara di sekitar daun. Coba tempat yang lebih tenang dulu.",
          "Jangan biarkan satu angka udara kering membuat kita menebak kondisi tanah. Ubah udaranya, tunggu, lalu dengarkan sensornya.",
          "Perawat yang baik menyebut masalah dengan tepat: udara kering. Jadi kita memperbaiki lingkungan, bukan mengarang masalah tanah.",
        ],
        HumidAir: [
          ...
          "Udara berat bisa lama tinggal di sekitar daun. Beri ventilasi lembut, lalu lihat apakah kelembapannya turun.",
          "Udara segar itu berguna, tetapi kipas keras tidak. Pilih aliran lembut dan ubah satu hal itu saja.",
          "Saat kelembapan udara tinggi, daun butuh ruang bernapas. Pastikan tanaman tidak terlalu rapat dengan dinding.",
          "Mari lapangkan area di sekitar tanaman, tunggu sebentar, lalu minta petunjuk baru dari sensor kelembapan.",
        ],
        Sleepy: [
          ...
          "Kalau masih siang, sensor cahaya meminta tempat yang lebih terang dan aman. Kalau malam, gelap memang waktunya tidur.",
          "Mendekatlah ke cahaya dengan hati-hati, tetapi jangan menukar gelap dengan panas berbahaya. Periksa cahaya dan suhu sesudahnya.",
          "Membuka tirai adalah perubahan terkecil, jadi mulai dari sana. Lalu lihat apakah sensor cahaya merasa cukup.",
          "Tanaman mengikuti siang, Nak. Beri cahaya pagi yang aman dan amati sebelum memindahkannya lagi.",
        ],
        Soil: [
          ...
          "Angka pH adalah petunjuk untuk dicatat, bukan resep. Tunjukkan kepada guru atau petani setempat sebelum melakukan perawatan.",
          "Mengubah kimia tanah tanpa panduan bisa membuat masalah kedua. Catat bacaannya dan tanyakan kepada orang dewasa berpengalaman.",
          "Mari ukur sekali lagi sebelum menilai tanah. Jika angkanya tetap tidak pas, bawa kedua bacaan kepada gurumu.",
          "Petani bijak tahu kapan harus meminta bantuan. pH tanah adalah salah satu saat itu, Nak.",
        ],
        Happy: [
          ...
          "Saat semua bacaan nyaman, berbuat lebih sedikit bisa lebih bijak. Pertahankan lingkungannya tetap stabil.",
          "Angka yang sehat bukan ajakan untuk terus mengutak-atik, Nak. Amati, ingat, dan biarkan tanaman tumbuh.",
          "Kebun mengajarkan keseimbangan hari ini: cahaya cukup, udara lembut, dan tangan yang sabar.",
        ],
        idle: {
          companion: [
