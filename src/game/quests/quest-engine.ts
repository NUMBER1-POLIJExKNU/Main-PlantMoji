...
import { QUEST_DEFINITIONS, questsTriggeredBy } from "./quest-definitions";
...
// Lives in ./sensor-recovery so the browser-side cheat sandbox can ask the
// same question without importing this module's Supabase helpers. Re-exported
// here because the engine is its main runtime caller (and tests import it from
// this path).
export { sensorBlocksRecovery } from "./sensor-recovery";
