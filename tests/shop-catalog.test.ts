...
describe("SHOP_CATALOG", () => {
  ...
  it("covers all three categories with the spec's item families", () => {
    ...
    expect(byCategory("accessory")).toEqual(["acc_strawhat", "acc_ribbon", "acc_glasses", "acc_coffee_crown", "acc_bandana", "acc_goggles", "acc_jfc_headdress", "acc_indonesia_sash"]);
    expect(SHOP_CATALOG).toHaveLength(27);
  });
